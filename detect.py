...
cap = cv2.VideoCapture('/home/scarlett/Samarth/Helmet_Detection.mp4')
...
writer = cv2.VideoWriter('output_helmet_detection.avi', fourcc, 5,(888,500))
# writer_full = cv2.VideoWriter('output_plate_1.avi', fourcc, 5,(888,500))
...
# cv2.imwrite('contour1.png', cropped_image)
    ...
    # writer_full.write(cropped_image)
